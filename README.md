...
5. **NEB Calculation is an unrelaxed proxy** - due to compute limits, the 0.92 eV migration barrier is a first-iteration SCF estimate, not a fully converged saddle point (though it is highly physically realistic).
