...
All analysis notebooks live in [`notebooks/`](./notebooks/).
...
**Notebook:** [`notebooks/1.calphad_equilibrium.ipynb`](./notebooks/1.calphad_equilibrium.ipynb)
...
**Notebook:** [`notebooks/2.dft_clustering.ipynb`](./notebooks/2.dft_clustering.ipynb)
...
**Notebook:** [`notebooks/3.neb_migration_barrier.ipynb`](./notebooks/3.neb_migration_barrier.ipynb)
...
**Phase fraction vs temperature plot:** generated by [notebook 1](./notebooks/1.calphad_equilibrium.ipynb).

![Phase fraction vs T](./figures/fig1_phase_fraction_vs_T.png)

**Isothermal equilibrium at 480 °C:** generated by [notebook 1](./notebooks/1.calphad_equilibrium.ipynb).
...
**DFT clustering bar chart:** generated inline in [notebook 2](./notebooks/2.dft_clustering.ipynb).
...
This relationship yields the following kinetic extrapolation (generated by [notebook 3](./notebooks/3.neb_migration_barrier.ipynb)):
...
jupyter notebook notebooks/1.calphad_equilibrium.ipynb
jupyter notebook notebooks/2.dft_clustering.ipynb
jupyter notebook notebooks/3.neb_migration_barrier.ipynb
```

[Notebook 2](./notebooks/2.dft_clustering.ipynb) only plots pre-computed energies - no DFT software needed.
...
│   ├── 2.dft_clustering.ipynb         # DFT energy comparison
│   └── 3.neb_migration_barrier.ipynb  # NEB kinetics & Arrhenius extrapolation
